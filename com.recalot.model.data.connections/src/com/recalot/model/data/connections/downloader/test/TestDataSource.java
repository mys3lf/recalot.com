...
package com.recalot.model.data.connections.downloader.test;
 ...
 */
public class TestDataSource extends BaseDownloaderDataSource {
    ...
    public void connect() throws BaseException {
        try {
            ...
            downloadData("ciao", "http://librec.net/datasets/CiaoDVD.zip");

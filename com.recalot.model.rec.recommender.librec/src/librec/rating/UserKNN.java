...
@Configuration(key = "similarityShrinkage", type = ConfigurationItem.ConfigurationItemType.Integer, description = "similarity shrinkage", value = "25")
@Configuration(key = "knn", type = ConfigurationItem.ConfigurationItemType.Integer, description = "number of nearest neighbors", value = "80")
@Configuration(key = "isRankingPred", type = ConfigurationItem.ConfigurationItemType.Boolean, requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional, value = "true")

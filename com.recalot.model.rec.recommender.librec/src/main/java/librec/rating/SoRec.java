...
@Configuration(key = "regC", requirement = ConfigurationItem.ConfigurationItemRequirementType.Required, type = ConfigurationItem.ConfigurationItemType.Double)
@Configuration(key = "regZ", requirement = ConfigurationItem.ConfigurationItemRequirementType.Required, type = ConfigurationItem.ConfigurationItemType.Double)
public class SoRec extends SocialRecommender {

	private DenseMatrix Z;
	public double regC, regZ;

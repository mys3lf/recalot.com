...
@Configuration(key = "rho", requirement = ConfigurationItem.ConfigurationItemRequirementType.Required, type = ConfigurationItem.ConfigurationItemType.Double)
@Configuration(key = "gSize", requirement = ConfigurationItem.ConfigurationItemRequirementType.Required, type = ConfigurationItem.ConfigurationItemType.Integer)
public class GBPR extends SocialRecommender {
    ...
    public void initModel() throws Exception {
		...
		userItemsCache = trainMatrix.rowColumnsCache(guavaCacheSpec);
		itemUsersCache = trainMatrix.columnRowsCache(guavaCacheSpec);
	}

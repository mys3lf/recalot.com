...
@Configuration(key = "uniformUserSampling", type = ConfigurationItem.ConfigurationItemType.Boolean, value = "true", requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional)
@Configuration(key = "biasReg", type = ConfigurationItem.ConfigurationItemType.Double, value = "0", requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional)
@Configuration(key = "numFeatures", type = ConfigurationItem.ConfigurationItemType.Integer, value = "100", requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional)
@Configuration(key = "initialSteps", type = ConfigurationItem.ConfigurationItemType.Integer, value = "100", requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional)
@Configuration(key = "learnRate", type = ConfigurationItem.ConfigurationItemType.Double, value = "0.05", requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional)
@Configuration(key = "regU", type = ConfigurationItem.ConfigurationItemType.Double, value = "0.0025", requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional)
@Configuration(key = "regI", type = ConfigurationItem.ConfigurationItemType.Double, value = "0.0025", requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional)
@Configuration(key = "regJ", type = ConfigurationItem.ConfigurationItemType.Double, value = "0.00025", requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional)
@Configuration(key = "updateJ", type = ConfigurationItem.ConfigurationItemType.Boolean, value = "true", requirement = ConfigurationItem.ConfigurationItemRequirementType.Optional)
...
//		System.out.println("Init done BPR");
     ...
     *
     * @param u        Number - the mapped userID
     * @param i        Number - the mapped itemID of a viewed item
     * @param j        Number - the mapped itemID of an unviewed item
     * @param update_u Boolean - should u be updated
